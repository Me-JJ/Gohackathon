...
export default function Announcements() {
  return (
    <div
      className="pt-2 px-5 border bg-gradient-to-tr from-light-green-100
     via-cyan-200 to-light-green-200  w-1/2 me-2 rounded-[30px]"
    >
      <div
        id="announcementAndShare"
        className="flex justify-between mb-1 items-center"
      >
        <span className="text-3xl font-medium flex justify-evenly items-center">
          Announcements
          <svg
      ...
      <div className=" rounded-2xl flex flex-col items-center p-2">
        <Image
          priority={false}
          src={hackathon}
          alt="Hackathon"
          style={{ width: "300px", height: "auto", borderRadius: "30px" }}
          className="mb-3"
        />
        {/* <PurpleToPink text={"Read More"} /> */}
        <MaterialButton_out text={"Read more"} />
      </div>
      <div className="flex justify-around mt-1 mx-5 p-2">
